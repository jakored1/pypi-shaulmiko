...
setup(
  ...
  download_url = 'https://github.com/jakored1/pypi-shaulmiko/archive/refs/tags/v_0.1.tar.gz',    # I explain this later on
  keywords = ['ShaulMiko', 'SSH', 'ssh', 'session', 'telnetlib', 'tty', 'cisco', 'router', 'switch', 'jakored', 'Ashal'],   # Keywords that define your package best
